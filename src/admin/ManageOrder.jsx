...
import { 
  ...
  Clock, Printer, X, Loader2, AlertTriangle 
} from "lucide-react";
...
export default function ManageOrders() {
  ...
  // --- 2. FETCH CHI TIẾT ĐƠN HÀNG (KHI BẤM XEM) ---
  const handleViewDetail = async (orderId) => {
      ...
      try {
          ...
          if (res.ok) {
              const data = await res.json();
              setSelectedOrder(data); // Data này đã bao gồm mảng 'tickets'
          } else {
  ...
  const handleUpdateStatus = async (newStatus) => {
    ...
    try {
        ...
        if (res.ok) {
            ...
            // Cập nhật UI Danh sách bên ngoài
      ...
      <div className="p-6 bg-gray-50 min-h-screen font-sans relative">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">Theo dõi trạng thái đặt vé và doanh thu (Data thật).</p>
          </div>
            ...
            {isLoading ? (
                ...
                <div className="overflow-x-auto">
                    ...
                    <thead>
                        ...
                        {/* Bỏ cột "Trận đấu" ở bảng chính vì 1 đơn có thể mua nhiều vé khác trận, xem chi tiết sẽ thấy */}
